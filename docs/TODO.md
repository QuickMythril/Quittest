...
- Search UX polish:
  - Add sorting options on Users/Hashtags tabs: e.g., Name (A–Z) and Most Recent for users; Name/Most Recent/Most Popular for hashtags.
...
- Profile link copying: Add a “Copy profile link” button on user profile pages (similar to post share).
